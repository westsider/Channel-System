...
//                WklyStats().updateCumulativeProfit(date: today.element.date, entryDate: Date(), ticker: "N/A", profit: today.element.profit, cost: today.element.cost, maxCost: maxCosts)
//            }
//            
//            counter += 1
//            if counter == maxCount {
